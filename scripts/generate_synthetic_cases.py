...
laeuft ueber die vier von Hand kuratierten Golden-Cases (Tag 64); diese
...
TEMPLATES: list[dict[str, str]] = [
    ...
    },
    {
        ...
        "example_process": (
            ...
            "Warengruppe Buereomoebel zugeordnet."
        ),
    },
]
...
VARIANTS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "time_savings_hours_per_case": 0.15,
        "frequency_per_year": 60000,
    ...
    for template in TEMPLATES:
        for variant in VARIANTS:
            use_case = UseCaseInput(
                ...
                time_savings_hours_per_case=variant["time_savings_hours_per_case"],
                frequency_per_year=variant["frequency_per_year"],
                ...
                implementation_complexity=variant["implementation_complexity"],
...
def _build_edge_cases() -> list[EvalCase]:
    ...
    edge_specs: list[dict[str, Any]] = [
        {
            "suffix": "Max-Werte",
            "time_savings_hours_per_case": 8.0,
            "frequency_per_year": 1_000_000,
            "affected_employees_count": 50_000,
            "employee_category": EmployeeCategory.MIXED,
            "evidence_level": EvidenceLevel.TESTED_PILOTED,
            "adoption_type": AdoptionType.MANDATORY,
            "implementation_approach": ImplementationApproach.CUSTOM_BUILD,
        ...
        },
        {
            ...
            "time_savings_hours_per_case": 1.2,
            "frequency_per_year": 250,
            "affected_employees_count": 3,
            "employee_category": EmployeeCategory.PROFESSIONAL,
            "evidence_level": EvidenceLevel.SIMILAR_PROJECT,
            "adoption_type": AdoptionType.MANDATORY,
            ...
            "competitive_pressure": False,
            "strategic_priority": False,
            "notes": "Vendor-Loesung mit Lizenzkosten = 0 (z.B. Open-Source-Vendor).",
        },
        {
            "suffix": "Druck-trotz-Mini",
            "time_savings_hours_per_case": 0.3,
            "frequency_per_year": 30,
            "affected_employees_count": 1,
            "employee_category": EmployeeCategory.JUNIOR,
            "evidence_level": EvidenceLevel.PURE_ESTIMATE,
            "adoption_type": AdoptionType.VOLUNTARY,
    ...
    for i, spec in enumerate(edge_specs, start=31):
        use_case = UseCaseInput(
            ...
            time_savings_hours_per_case=spec["time_savings_hours_per_case"],
            frequency_per_year=spec["frequency_per_year"],
